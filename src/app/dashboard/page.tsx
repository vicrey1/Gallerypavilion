              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      checked={createFormData.allowDownloads}
                      onChange={(e) => setCreateFormData(prev => ({ ...prev, allowDownloads: e.target.checked }))}
                      className="rounded"
                    />
                  ...
                  <label className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      checked={createFormData.requirePassword}
                      onChange={(e) => setCreateFormData(prev => ({ ...prev, requirePassword: e.target.checked }))}
                      className="rounded"
                    />
                    <span className="text-gray-300">Require password</span>
                  </label>
                  
                  {createFormData.requirePassword && (
                    <div>
