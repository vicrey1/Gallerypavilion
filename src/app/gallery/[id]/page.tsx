            ...
            {selectedPhotos.size > 0 && (
              <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
                <span className="text-white text-sm">{selectedPhotos.size} selected</span>
                 <div className="flex space-x-2">
                   <button
                     onClick={() => window.open(`mailto:support@gallery.com?subject=Certificate Request for Selected Photos&body=Hello, I would like to request certificates of authenticity for the selected photos.`, '_blank')}
