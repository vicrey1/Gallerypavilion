                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <button
                            onClick={(e) => { e.stopPropagation(); window.open(`mailto:${galleryData?.gallery.photographer.user.email}?subject=Certificate Request: ${photo.title || photo.filename}&body=Hello, I would like to request the certificate of authenticity for this artwork.`, '_blank'); }}
